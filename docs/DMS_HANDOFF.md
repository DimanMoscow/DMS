...
Last audited: 2026-09-07 (Europe/Moscow).
...
- P1 is complete. Start P2 or any new functional stage only on explicit instruction,
  preferably in a fresh task recovered from current Git and live read-only state.
